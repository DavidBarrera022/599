...
class ClLibFrameworkControl:
    ...
    def create_file_bucket(self, project_id):
        try:
            ...
            # Determinar el bucket segun el valor de project_id
            if project_id == 'bdb-gcp-qa-cds-idt':
                bucket = 'bdb-gcp-qa-cds-idt-framework-control'
            elif project_id == 'bdb-gcp-st-cds-idt':
                bucket = 'bdb-gcp-st-cds-idt-frm-control-zone'
            elif project_id == 'bdb-gcp-pr-cds-idt':
                bucket = 'bdb-gcp-pr-cds-idt-frm-control-zone'
            else:
                bucket = 'bdb-gcp-pr-cds-idt-frm-control-zone'
